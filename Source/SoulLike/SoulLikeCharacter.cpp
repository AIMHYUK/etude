...
ASoulLikeCharacter::ASoulLikeCharacter()
{
	...
	(TEXT("/Game/ThirdPerson/Input/Actions/IA_Run"));
	if (IA_Run.Succeeded())
		RunAction = IA_Run.Object; //달리기 추가
}
...
void ASoulLikeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Running
		EnhancedInputComponent->BindAction(RunAction, ETriggerEvent::Triggered, this, &ASoulLikeCharacter::Run);
	}
	else
	{
...
void ASoulLikeCharacter::Run(const FInputActionValue& Value)
{
